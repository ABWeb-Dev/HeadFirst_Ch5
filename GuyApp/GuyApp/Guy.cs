...
namespace GuyApp
{
    class Guy
    {
        ...
        /// <summary>
        /// Writes my name and the amount oc cash I have to the console.
        /// </summary>
        ...
        /// <summary>
        /// Gives some of my cash, remocing it from my wallet (or printing a message 
        /// to the console if I don't have enough cash).
        /// </summary>
        ...
        /// </summary>
        /// <param name="amount">Amount of cash receive</param>
